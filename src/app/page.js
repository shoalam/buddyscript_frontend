...
export default function Home() {
  const posts = [
    ...
    },
    {
      author: "Steve Jobs",
      time: "42 minute ago",
      content: "Creating the next big thing.",
      image: "/images/timeline_img.png",
      authorImg: "/images/people1.png",
      reacts: 15,
      comments: 5,
      shares: 20
    }
